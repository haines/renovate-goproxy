module github.com/haines/renovate-goproxy

go 1.24.1

require riverqueue.com/riverpro/cmd/riverpro v0.14.0
...
require (
	...
	riverqueue.com/riverpro v0.13.0 // indirect
	riverqueue.com/riverpro/driver v0.13.0 // indirect
	riverqueue.com/riverpro/driver/riverpropgxv5 v0.13.0 // indirect
)
